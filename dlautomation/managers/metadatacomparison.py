...
class MetaDataComparison:
    ...
    def endpoints_metadata(row):
        ...
        try:
            ...
            follow_columns_mapping = row[7]
            #fetching columns mapping flag for active table
            ...
            filtered_source_columns, filtered_target_columns = MetaDataComparison.get_filtered_list(source_table,
                                                               source_columns, source_excluded_columns, target_table,
                                                               target_columns, target_excluded_columns)
    ...
    def compare_metadata():
        ...
        try:
            ...
            for row in active_tables:
                ...
                follow_columns_mapping, source_table, source_columns, target_table, target_columns = \
                                                                            MetaDataComparison.endpoints_metadata(row)
